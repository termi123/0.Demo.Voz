...
public class MenuListAdapter extends ArrayAdapter<vozURLBean> {

	LayoutInflater inf;
	LinkedList<vozURLBean> objects;
	boolean main;

	public MenuListAdapter(Context context, int resource, int textViewResourceId,
			LinkedList<vozURLBean> objects, boolean main) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		vozURLBean s = objects.get(position);
		if (convertView == null) {
